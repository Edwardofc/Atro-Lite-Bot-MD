...
# Modificado por @Edwardofc

#!/data/data/com.termux/files/usr/bin/bash 
# Interpretación determinada para la ejecución     
COMANDOS = "pkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Edwardofc/Atro-Lite-bot-MD\ncd Atro-Lite-bot-MD\nyarn install\nnpm install\nnpm start"
...
git clone https://github.com/Edwardofc/Atro-Lite-bot-MD.git
...
echo -e "\033[38;5;188m\033[01m🚀 Iniciando Atro-Lite-bot-MD!!\n\033[0m"
npm start
