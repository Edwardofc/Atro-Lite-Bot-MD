...
conn.reply('51935531943@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, { contextInfo: { mentionedJid: [m.sender] }})

conn.reply(m.chat, `❇️ *El reporte se envió a mi creador, tendrá una respuesta más tarde*`, m, fake, )
